...
public class FeeResultObject
{
	...
	{
		return "FeeResultObject [feed_id=" + feed_id + ", type=" + type + ", feedback_img1=" + feedback_img1 + ", feedback_img2=" + feedback_img2 + ", feedback_img3=" + feedback_img3
				+ ", feedback_img4=" + feedback_img4 + ", feedback_description=" + feedback_description + ", feedback_title=" + feedback_title + ", feedback_type=" + feedback_type
				+ ", feedback_datetime=" + feedback_datetime + ", user_id=" + user_id + ", feedback_id=" + feedback_id + ", imgarr=" + imgarr + "]";
	}
